...
<link rel="stylesheet" href="${basePath}css/system.css" media="screen">
<script src="${basePath}js/ckeditor/ckeditor.js"></script>
<script src="${basePath}js/util.js"></script>
</head>
<body>
<div class="download"><a id="download">下载</a></div>
<div class="title"><c:out value="${system.name}"/></div>
<div class="introduction"><c:out value="${system.description}" escapeXml="false"/></div>
<div class="discuss">
	...
	<div class="subcontent">
		...
		<div>
			...
			<form id="submit_form">
	            ...
	            <input type="submit" value="提交" class="submit_btn" id="systemsubmit"/>
	        </form>
	   	</div>
	</div>
</div>
    ...
    require(["dojo/dom", "dojo/on", "dojo/request", "dojo/dom-form", "dojo/json"],
    	    function(dom, on, request, domForm, JSON){
    	        ...
    	        on(form, "submit", function(evt){
    	            ...
    	            request.post("${basePath}system/insertcomment/${system.id}.do", {

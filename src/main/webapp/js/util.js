...
var localization = function(i18n) {
	require([ "dojo/dom-construct", "dojo/domReady!", "dojo/dom" ], function(
			domConst, domReady, dom) {
		for ( var i in i18n) {
			if (i != "$locale") {
...
var changeLanguage = function(language) {
	require([ "dojo/dom", "dojo/on", "dojo/request", "dojo/dom-form",
			"dojo/json" ], function(dom, on, request, domForm, JSON) {

		request.post("/ai/login/changelanguage.do", {
			data: {
				language:language
            }
		}).then(function() {
